...
- product options
    ...
    - machine learning algoriothm: data model is trained with data and then used to predict results for new data
    - Azure Machine Learning
        - set up process for obtaining, cleaning and spliting data
        - train and evaluate models
        - define where and when training should occur (since it's computationaly intensive and shouldn't be run anywhere, anytime)
    ...
    - Azure Bot Service
        ...
        - meant to automate simple or repetive tasks
